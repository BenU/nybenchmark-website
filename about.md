...
title: About
permalink: /about/
description: "About BenchmarkUSA: a civic-tech initiative making local government financial data comparable and accessible, starting in New York State and expanding nationwide. Created by Benjamin Unger."
---
...
The project began in New York State, benchmarking the state's 62 cities, and has since expanded to cover towns, villages, counties, and school districts across the state. The data application now lives at **[benchmarkusa.org](https://benchmarkusa.org)** to reflect the project's growing national scope.

BenchmarkUSA is **nonpartisan** and **evidence-based**. Data is imported from official public sources — state comptrollers, municipal financial reports, and federal agencies including the [U.S. Census Bureau](https://www.census.gov/data.html) — and every data point traces to its source so that claims can be verified and debated on the merits.

## Who is behind this

BenchmarkUSA was created by [Benjamin Unger](https://benjaminunger.com), an anesthesiologist and software developer based in Yonkers, New York.
...
The application at **[benchmarkusa.org](https://benchmarkusa.org)** currently serves 15.3 million+ observations covering 62 cities, 57 counties, 933 towns, 558 villages, and 689 school districts, with ranked dashboards, trend charts, fiscal stress analysis, and derived fiscal health metrics (Fund Balance %, Debt Service %, Per-Capita Spending).
...
- `contact@benchmarkusa.org`
- [benjaminunger.com](https://benjaminunger.com)
- [@ben_unger](https://x.com/ben_unger) on X
