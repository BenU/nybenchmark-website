...
<figure style="margin: 2rem 0; text-align: center;">
  <img src="{{ '/assets/images/posts/state-local-government-financial-data/state-data-availability-map.png' | relative_url }}" 
...
Live New York benchmarking work based on this analysis is available at [benchmarkusa.org](https://benchmarkusa.org).
